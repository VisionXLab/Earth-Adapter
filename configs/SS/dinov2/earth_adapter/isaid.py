...
model = dict(
    backbone = dict(
        ...
        adapter_config = dict(#base config
            dim = 16,
            with_token = False,
        ),
    ),
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=8000,max_keep_ckpts=1,save_best='mIoU'),
